    ...
    <div className="group relative flex flex-col w-full h-full min-h-40 p-6 border bg-base-100 border-outlineColor rounded-xl shadow-sm hover:shadow-lg transform transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/50 cursor-pointer select-none overflow-hidden">
      ...
      <div className="flex flex-col h-full justify-between">
        <div className="flex items-start justify-between gap-4 mb-4">
          <h2 className="font-semibold font-sans text-sm uppercase tracking-wide text-secondary group-hover:text-primary transition-colors duration-300">
            {title}
          </h2>
          {Icon && (
        ...
        <div className="flex items-baseline gap-2">
          <p className="text-4xl font-bold font-display text-primary group-hover:scale-105 transition-transform duration-300">
            {value}
          </p>
        </div>
      </div>
